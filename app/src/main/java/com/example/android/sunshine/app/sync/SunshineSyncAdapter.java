...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void notifyWeather() {
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            if (cursor.moveToFirst()) {
                ...
                Intent weatherApp = new Intent(getContext(), MainActivity.class);

                TaskStackBuilder stackBuilder = TaskStackBuilder.create(getContext());
                stackBuilder.addParentStack(MainActivity.class);
                stackBuilder.addNextIntent(weatherApp);
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor loc = getContext().getContentResolver().query(
        ...
        if(loc.moveToFirst())
        {
            return loc.getLong(0);
        }

        ContentValues newValues = new ContentValues();
        newValues.put(WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING, locationSetting);
        ...
        Uri newLocURI = getContext().getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI, newValues);
        return ContentUris.parseId(newLocURI);
    }
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            Log.d(LOG_TAG, "Weather load complete. " + inserted + " Inserted");
            pruneOldData();
            return null;
    ...
    private void pruneOldData()
    {
        ...
        long dbDelDate = WeatherContract.normalizeDate(calendar.getTimeInMillis());
        int deleted = getContext().getContentResolver().delete(
                WeatherContract.WeatherEntry.CONTENT_URI
                , WeatherContract.WeatherEntry.COLUMN_DATE + " <= " + dbDelDate
                ,null);
        Log.v(LOG_TAG, "Deleted entries: " + deleted);
    }
